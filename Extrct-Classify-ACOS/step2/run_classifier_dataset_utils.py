...
def convert_examples_to_features(examples, label_list, max_seq_length,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        _truncate_seq_pair(bert_tokens_a, max_seq_length - 2)
        ...
        # pred_sentiment_label = None
        # if len(ao_tags.split()) == 2:
        #     pred_sentiment_label = 0
        # else:
        #     pred_sentiment_label = int(ao_tags.split()[2])
        if len(labels) > 0:
